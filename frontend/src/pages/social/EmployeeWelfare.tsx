  ...
  return (
    <div>
      ...
      <div ref={scrollRef} onWheel={onWheel}>
        <Table columns={columns} dataSource={filteredRecords} loading={loading} scroll={{ x: 1800 }} size="small" pagination={{ pageSize: 50, showSizeChanger: true, showTotal: t => `共 ${t} 条` }} />
      </div>
